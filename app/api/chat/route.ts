...
자연스러운 한국어 문장으로 정리해주세요. 번호 매기지 말고, 토론에서 바로 활용할 수 있는 형태로.`,
    );
...
대화 맥락에 따라 자연스럽게 전환합니다. 아래 방식들은 학술적으로 검증된 토론 방법론에서 추출한 기법입니다.
